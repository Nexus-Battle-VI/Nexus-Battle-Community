 ...
 * Catalog: es lo unico que hace que las dos partes lleguen a la misma firma.
 ...
 *
 * SE DUPLICA A PROPOSITO, igual que en Commerce y en Catalog. Un paquete comun
 * de identidad acoplaria los servicios: cualquier cambio obligaria a un
 * despliegue coordinado, y el limite entre contextos dejaria de existir en la
 * practica. El precio es esta copia; el contrato que ambas partes deben
 * respetar esta descrito en los dos ficheros.
 */

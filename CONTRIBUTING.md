# Contribución a Nexus-Battle-Community
...
```text
feat/hu-41-publicar-mensaje
fix/bug-12-hilo-cerrado
chore/bootstrap-sprint1-foundation
ci/cache-dependencias
docs/contrato-openapi
test/cobertura-moderacion
refactor/politica-de-moderacion
```
...
```text
feat(community): [HU-41] publicar mensaje en un hilo
fix(community): [BUG-12] impedir publicar en un hilo cerrado
```
